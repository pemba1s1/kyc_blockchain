...
contract('KYC',accounts=>{
    ...
    describe("registerKYC() &  requestKYC()",async() => {
        it('KYC added, request added',async()=>{
            await kyc.registerKYC('0x1e84892176f6aE044E620C61133Ce5532166d8DC','json','photo','front','back',true,{from : '0xD0B5BAED90404ADaB3163bFFa9Ba6543C9301025'})
    ...
    describe("updateKYC() & viewKYC()",async() => {
        it("KYC updated",async()=>{
            await kyc.updateKYC('0x1e84892176f6aE044E620C61133Ce5532166d8DC','jsonupdated','photo','front','back',true,{from : '0xD0B5BAED90404ADaB3163bFFa9Ba6543C9301025'})
            const name = await kyc.viewKYC('0x1e84892176f6aE044E620C61133Ce5532166d8DC',{from:'0xD0B5BAED90404ADaB3163bFFa9Ba6543C9301025'})
    ...
    describe("removeKYC()",async()=>{
        it("kyc removed",async()=>{
            await kyc.requestKYC('0x1e84892176f6aE044E620C61133Ce5532166d8DC',{from:'0xD0B5BAED90404ADaB3163bFFa9Ba6543C9301025'})
            await kyc.giveAccessKYC(0,'0xD0B5BAED90404ADaB3163bFFa9Ba6543C9301025',true,{from : '0x1e84892176f6aE044E620C61133Ce5532166d8DC'})
            await kyc.removeKYC('0x1e84892176f6aE044E620C61133Ce5532166d8DC',{from :'0xD0B5BAED90404ADaB3163bFFa9Ba6543C9301025'})
        })
    })
